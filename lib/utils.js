...
/**
 * 根据栏目返回对应的后台管理路由前缀（/admin/sections/learning 或 /finance）。
 */
export function sectionAdminPath(section) {
  return `/admin/sections/${section === "FINANCE" ? "finance" : "learning"}`;
}

/**
 * 根据栏目返回后台管理小写标识（learning / finance）。
 */
export function sectionAdminKey(section) {
  return section === "FINANCE" ? "finance" : "learning";
}
